                            ...
                            <div class="col-sm-8">
                                ...
                                <select name="cmbCode" class="form-control" id="cmbCode" >
                                    ...
                                    <?php  foreach($cashs as $cash) { echo $cash->HeadName; ?>
                                        <option value="<?php echo $cash->HeadCode;?>" <?php echo $cash->HeadCode==$cmbCode? 'selected' :'';?> ><?php echo $cash->HeadName;?></option>
            ...
            <div class="panel-body"  id="printArea">
                ...
                <div class="table-responsive">
                    <table width="100%" class="table table-stripped" cellpadding="6" cellspacing="1">
                       ...
                       <caption class="text-center"><font size="+1"> <strong> <?php echo display('cash_book_report')?>  (<?php echo display('from')?> <?php echo (!empty($dtpFromDate)?$dtpFromDate:''); ?> <?php echo display('to')?> <?php echo (!empty($dtpToDate)?$dtpToDate:'');?>)</font><strong></caption>
                        <thead>
