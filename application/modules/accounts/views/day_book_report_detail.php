...
<?php if($allvouchers) {?>
<div class="row mt-100-50 day_book_report_detil" id="vaucherPrintArea">
               ...
               <tbody>
                   <?php
                    ...
                    if(!empty($singlevoucher)){
                        ...
                        <?php }?>
                            <tr>
                                <td class="text-left"><strong class="dbtcrdhead"><?php echo $singlevoucher->dbtcrdHead;?></strong></td>
...
<script src="<?php echo MOD_URL.'accounts/assets/js/day_book_report_detail.js'; ?>" type="text/javascript"></script>