     ...
     <div class="col-sm-12 col-md-12">
            <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body"> 
                        <?php echo form_open('accounts/expenditure_statement_report',array('class' => 'form-inline','method'=>'post'))?>
        ...
        <div class="panel panel-bd lobidrag">
            ...
            <div id="printArea">
                <div class="panel-body">
                   <table width="99%" align="left" class="table table-striped table-bordered table-hover general_ledger_report_tble">
                    ...
                    <thead>
                    <tr>
                        <th colspan="2" align="center" ><b><?php echo display('expenditure_statement')?><br/><?php echo display('from')?> <?php echo $dtpFromDate ?> <?php echo display('to')?> <?php echo $dtpToDate;?></b></th>
                    </tr>
                    <tr>
            ...
            <div class="text-center" id="print">
             ...
             <a href="<?php echo base_url($pdf)?>" target="_blank" title="download pdf">
              ...
              <a href="<?php echo base_url('accounts/expenditure_statement_report_excel/'.$dtpFromDate.'/'.$dtpToDate)?>" target="_blank" title="download Excel">
