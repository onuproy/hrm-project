                    ...
                    <div class="form-group form-group-new empdropdown">
                         <select class="form-control" name="fyear">                                
                                <?php foreach($fyears as $fyear){?>
                                  <option value="<?php echo $fyear->id;?>" <?php echo $fyear->id== $curentYear->id? 'selected':'' ; ?> ><?php echo $fyear->yearName;?></option>
                              <?php }?>
                              </select>  
                     </div> 
...
<div class="row">
    <div class="col-sm-12" id="printArea">
        <div class="panel">
            <div class="panel-heading">
               <div class="panel-title">
                    <h4><?php echo display('income_statement')?> for <?php echo $curentYear->yearName ;?></h4>
                </div>
            </div>
            <div class="panel-body">
                ...
                <table width="99%" align="left" class="table table-striped table-bordered table-hover general_ledger_report_tble">
                    <thead>
                      <tr>
                           <th width="16%" bgcolor="#E7E0EE" align="left" class="profitamount"><?php echo display('particulars')?></th>
                ...
                <tr>
                 ...
                 <?php } } }  } } } if($startmonth == 1) { ?>
                  ...
                  <tr>
                    ...
                    <td  align="right" class="profitamount" ><strong><?php echo $setting->currency_symbol. ' '. number_format($incomes[0]['gtotal1'] ,2); ?></strong></td>
                    <td  align="right" class="profitamount" ><strong><?php echo $setting->currency_symbol. ' '. number_format($incomes[0]['gtotal2'] ,2); ?></strong></td>
                    <td  align="right" class="profitamount" ><strong><?php echo $setting->currency_symbol. ' '. number_format($incomes[0]['gtotal3'] ,2); ?></strong></td>
                    <td  align="right" class="profitamount" ><strong><?php echo $setting->currency_symbol. ' '. number_format($incomes[0]['gtotal4'] ,2); ?></strong></td>
                    <td  align="right" class="profitamount" ><strong><?php echo $setting->currency_symbol. ' '. number_format($incomes[0]['gtotal5'] ,2); ?></strong></td>
                    <td  align="right" class="profitamount" ><strong><?php echo $setting->currency_symbol. ' '. number_format($incomes[0]['gtotal6'] ,2); ?></strong></td>
                    <td  align="right" class="profitamount" ><strong><?php echo $setting->currency_symbol. ' '. number_format($incomes[0]['gtotal7'] ,2); ?></strong></td>
                    <td  align="right" class="profitamount" ><strong><?php echo $setting->currency_symbol. ' '. number_format($incomes[0]['gtotal8'] ,2); ?></strong></td>
                    <td  align="right" class="profitamount" ><strong><?php echo $setting->currency_symbol. ' '. number_format($incomes[0]['gtotal9'] ,2); ?></strong></td>
                    <td  align="right" class="profitamount" ><strong><?php echo $setting->currency_symbol. ' '. number_format($incomes[0]['gtotal10'] ,2); ?></strong></td>
                    <td  align="right" class="profitamount" ><strong><?php echo $setting->currency_symbol. ' '. number_format($incomes[0]['gtotal11'] ,2); ?></strong></td>
                    <td  align="right" class="profitamount" ><strong><?php echo $setting->currency_symbol. ' '. number_format($incomes[0]['gtotal12'] ,2); ?></strong></td> 
                 </tr> 
             <?php } else { ?>
...
<div class="row">
    <div class="col-sm-12" >
         <div class="text-center" id="print">                
                ...
                <button class="btn btn-warning btn-md" name="btnPrint" id="btnPrint"  onclick="incomeStatementPrintPageArea('printArea');"><i class="fa fa-print"></i> Print </button>
             <a href="<?php echo base_url($pdf)?>" target="_blank" title="download pdf">
              ...
              <a href="<?php echo base_url('accounts/income_statement_excel/'.$curentYear->id)?>" target="_blank" title="download Excel">
