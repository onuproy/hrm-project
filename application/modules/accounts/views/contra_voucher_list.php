        ...
        <div class="panel panel-default thumbnail"> 
            <div class="panel-heading panel-aligner" >
                ...
                <div class="mr-25">
                    ...
                    <?php if($this->permission->check_label('contra_voucher')->create()->access()): ?>
                    <a href="<?php echo base_url("accounts/accounts/create_contra_voucher") ?>" class="btn btn-primary btn-md" ><i class="fa fa-plus-circle" aria-hidden="true"></i>
                            ...
                            <?php foreach ($voucherInfo as $row) { ?>
                                <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC"; ?>">
                                    ...
                                    <td class="center">
                                       ...
                                       <?php if($this->permission->check_label('contra_voucher')->update()->access()):   if($row->isApproved == 0 ) {?>
                                        ...
                                        <?php if($this->permission->check_label('contra_voucher')->delete()->access()):    
                                        if($row->isApproved == 0 ) { ?>  
...
<script src="<?php echo MOD_URL.'accounts/assets/js/contra_voucher_list.js'; ?>" type="text/javascript"></script>