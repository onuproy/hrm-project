        ...
        <div class="panel panel-default thumbnail"> 
            <div class="panel-heading panel-aligner" >
                <div class="panel-title">
                    <h4><?php echo display('debit_voucher') ?></h4>
                </div>
                <div class="mr-25">

                    <?php if($this->permission->check_label('debit_voucher')->create()->access()): ?>
                    <a href="<?php echo base_url("accounts/accounts/create_debit_voucher") ?>" class="btn btn-primary btn-md" ><i class="fa fa-plus-circle" aria-hidden="true"></i>
            ...
            <div class="panel-body">
                <table width="100%" class="datatableReport table table-striped table-bordered table-hover" title="devitVoucher">
                    <thead>
                        <tr>
                            ...
                            <?php foreach ($voucherInfo as $row) { ?>
                                <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC"; ?>">
                                   ...
                                   <td class="center">
                                       ...
                                       <?php if($this->permission->check_label('debit_voucher')->update()->access()):   if($row->isApproved == 0 ) {?>
                                       ...
                                       <?php } else {  if($row->isyearClosed == 0) {?>                                         
                                        ...
                                        <?php if($this->permission->check_label('debit_voucher')->delete()->access()):    
                                        if($row->isApproved == 0 ) { ?>  
...
<script src="<?php echo MOD_URL.'accounts/assets/js/debit_voucher_list.js'; ?>" type="text/javascript"></script>