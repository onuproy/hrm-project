        ...
        <div class="panel panel-default thumbnail"> 
            <div class="panel-heading panel-aligner" >
                <div class="panel-title">
                    <h4><?php echo display('journal_voucher') ?></h4>
                </div>
                <div class="mr-25">

                    <?php if($this->permission->check_label('journal_voucher')->create()->access()): ?>
                    <a href="<?php echo base_url("accounts/accounts/create_journal_voucher") ?>" class="btn btn-primary btn-md" ><i class="fa fa-plus-circle" aria-hidden="true"></i>
                            ...
                            <?php foreach ($voucherInfo as $row) { ?>
                                <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC"; ?>">
                                    ...
                                    <td class="center">
                                       ...
                                       <?php if($this->permission->check_label('journal_voucher')->update()->access()):   if($row->isApproved == 0 ) {?>
                                        ...
                                        <?php if($this->permission->check_label('journal_voucher')->delete()->access()):    
                                        if($row->isApproved == 0 ) { ?>  
    ...
    <div class="modal-dialog custom-modal-dialog">
        <div class="modal-content " >
            <div class="modal-header">
                <h5 class="modal-title font-weight-600" id="allAppointModalLabel">Vaucher Detail</h5>dffff
...
<script src="<?php echo MOD_URL.'accounts/assets/js/journal_voucher_list.js'; ?>" type="text/javascript"></script>