            ...
            <div class="panel panel-bd">
                ...
                <?php echo form_open_multipart('dashboard/setting/create','class="form-inner"') ?>
                    ...
                    <div class="form-group row">
                     ...
                     <div class="form-group row">
                        <label for="employer_contribution" class="col-xs-3 col-form-label"><?php echo display('employer_contribution').'(%)';?></label>
                        <div class="col-xs-9">
                            <input name="employer_contribution" type="number" class="form-control" id="currency_symbol" placeholder="<?php echo display('employer_contribution').'(%)' ?>" value="<?php echo $setting->employer_contribution ?>">
                        </div>
                    </div>

                    <div class="form-group row">
                        <label for="icf_amount" class="col-xs-3 col-form-label"><?php echo display('icf_amount');?></label>
                        <div class="col-xs-9">
                            <input name="icf_amount" type="number" class="form-control" id="currency_symbol" placeholder="<?php echo display('icf_amount') ?>" value="<?php echo $setting->icf_amount ?>">
                        </div>
                    </div>
