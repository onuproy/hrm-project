            ...
            <div class="panel">
                ...
                <div class="panel-body">
                    ...
                    <?php echo  form_open('loan/Loan/create_grandloan') ?>
                        ...
                        <div class="form-group row">
                            <label for="amount" class="col-sm-3 col-form-label"><?php echo display('amount') ?><?php echo $curncy_symbol;?> *</label>
                            <div class="col-sm-9">
                        ...
                        <div class="form-group row">
                         ...
                         <div class="form-group row">
                            <label for="repayment_amount" class="col-sm-3 col-form-label"><?php echo display('repayment_amount') ?><?php echo $curncy_symbol;?> </label>
                            <div class="col-sm-9">
                          ...
                          <div class="form-group row">
                            <label for="installment" class="col-sm-3 col-form-label"><?php echo display('installment') ?><?php echo $curncy_symbol;?></label>
                            <div class="col-sm-9">
        ...
        <div class="panel panel-bd"> 
             ...
             <div class="panel-heading panel-aligner" >
                ...
                <div class="mr-25">
                    ...
                    <?php if($this->permission->check_label('loan_grand')->create()->access()): ?>
                    <button type="button" class="btn btn-primary btn-md" data-target="#add0" data-toggle="modal"  ><i class="fa fa-plus-circle" aria-hidden="true"></i>
                    <?php echo display('add_loan')?></button> 
                    <?php endif; ?>
                    <?php //if($this->permission->method('loan_grand','read')->access()): ?>
                    <?php if($this->permission->check_label('loan_grand')->read()->access()): ?>
                ...
                <table width="100%" class="datatable table table-striped table-bordered table-hover">
                    <thead>
                        <tr>
                            ...
                            <th><?php echo display('installment_cleared') ?></th>
                        ...
                        <?php if (!empty($loan)) { ?>
                            ...
                            <?php foreach ($loan as $que) { ?>
                                <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                                    ...
                                    <td><?php echo $que->installment_cleared; ?>Month</td>
